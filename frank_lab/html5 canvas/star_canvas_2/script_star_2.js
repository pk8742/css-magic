...
class Particle{
	...
	draw(){
		...
		drawStar(x, y, 2, this.size, this.size); // no. of spikes 4,5
...
function init(){
	...
	for(let i=0;i<500;i++){ // no. of particles 500,50,100
		...
		let size = (Math.random() * 10) + 3; //size of the particles 8 0.5, 12 3
...
function animate(){
	...
	ctx.fillStyle = 'rgba(192,57,43,0.01)'; // fii style of particles like 0.1,0.01
